...
/**
 * aux_help_general - Displays general help information for the shell.
 * Return: None.
 */
...
write(STDOUT_FILENO, help, _strlen(help));
help = "Exits the shell with a status of N. If N is omitted, the exit status";
write(STDOUT_FILENO, help, _strlen(help));
help = " is that of the last command executed.\n";
write(STDOUT_FILENO, help, _strlen(help));
}
